...
class APDataObject:
    ...
    def get_ap(self) -> float:
        ...
        #print(11,sum(y_range) / len(y_range))
...
def evaluate(net:Yolact, dataset, train_mode=False):
    ...
    if not args.display and not args.benchmark:
        ...
        #print("ap",ap_data['box'][0][0].get_ap())
    ...
    try:
        ...
        for it, image_idx in enumerate(dataset_indices):
            ...
            #print("app",ap_data['box'][0][0].get_ap())
...
def calc_map(ap_data):
        ...
        for iou_idx in range(len(iou_thresholds)):
            for iou_type in ('box', 'mask'):
                ...
                if not ap_obj.is_empty():
                    ...
                    #print(iou_idx,iou_type,aps[iou_idx][iou_type])
    ...
    for j,iou_type in enumerate(['box', 'mask']):
        ...
        plt.clf()
        a=[]
        a.append(all_maps[iou_type]['all'])
        r=np.resize(r,(1,10))
        a.extend(r)
        a=np.array(a)
